					...
					>
						{pois.length === 0 && (
							<Text color="gray" size="2">
								No POIs yet. Import or add some!
							</Text>
						)}
						{pois.map((poi) => (
								...
								<Flex justify="between" align="start" gap="2" width="100%">
									...
									{user && (
										...
										>
											<Flex gap="3">
												<Dialog.Root
													open={editingPoi?.id === poi.id}
													onOpenChange={(open) => !open && setEditingPoi(null)}
												>
													<Dialog.Trigger>
														<IconButton
															size="1"
													...
													<Dialog.Content maxWidth="400px">
														...
														<Box mt="3">
															...
															>
																<Select.Trigger />
																<Select.Content>
																	<Select.Item value="geocoded">
																		geocoded
																	</Select.Item>
																	<Select.Item value="viewpoint">
																		viewpoint
																	</Select.Item>
																	...
																	<Select.Item value="imported_file">
																		imported_file
																	</Select.Item>
																</Select.Content>
															</Select.Root>
